...
grant SELECT, UPDATE, INSERT, DELETE on TABLE services, instances, components to eventdba;
grant SELECT, UPDATE on SEQUENCE service_id_seq, instance_id_seq, component_id_seq to eventdba;
